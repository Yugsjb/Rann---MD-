...
if (waktu < "23:59:00") {
    var ucapanWaktu = 'Konbanwa Senpai :3 🏙️'
}
if (waktu < "19:00:00") {
    var ucapanWaktu = 'Konbanwa Senpai :3 🌆'
}
if (waktu < "18:00:00") {
    var ucapanWaktu = 'Konnichiwa Senpai :3 🌇'
}
if (waktu < "15:00:00") {
    var ucapanWaktu = 'Konnichiwa Senpai :3 🌤️'
}
if (waktu < "10:00:00") {
    var ucapanWaktu = 'Konnichiwa Senpai :3 🌄'
}
if (waktu < "05:00:00") {
    var ucapanWaktu = 'Ohayou Senpai :3 🌆'
}
if (waktu < "03:00:00") {
    var ucapanWaktu = 'Oyasumi Senpai :3 🌃'
}
/* ~~~~~~~~~ STARTING & MODULE ALL ~~~~~~~~~ */
                ...
                myoku.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: 'Script Free',
                            body: `SCRIPT BOT ${namabot} Ada Di Youtube @myokudev`,
...
Hello ${pushname} 👋
𝙱𝚘𝚝 𝙽𝚊𝚖𝚎 : ${namabot}
⚘ 𝙲𝚛𝚎𝚊𝚝𝚘𝚛 : FallZx & ArxzyDev
⚘ 𝙲𝚘𝚗𝚝𝚊𝚌𝚝 : ${numberowner}
⚘ 𝚃𝚊𝚗𝚐𝚐𝚊𝚕: 16 Oktober 2023
